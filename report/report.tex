...
\begin{itemize}
  ...
  \item \href{https://documentation.api.train.vulpz.com}{Documentation}
...
\noindent
\newline
Docker was employed to containerise the application, this allows the application to be portable across different machines including deployment to a production environment. This allows the application to always operate as intended no matter the hosting environment.
