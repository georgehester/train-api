...
\begin{itemize}
  ...
  \item \href{https://documentation.api.vulpz.com}{Documentation}
...
\noindent
\newline
"A computer can never be held accountable, therefore a computer must never make a management decision." - \citep{ibm}
